...
class PredictionService:
    ...
    def __init__(self):
        ...
        self._label_encoder_loaded = False
    ...
    def load_models(self) -> bool:
        ...
        try:
            ...
            if label_encoder_path.exists():
                ...
                self._label_encoder_loaded = True
            ...
            return self._model_loaded and self._vectorizer_loaded and self._label_encoder_loaded
    ...
    def predict(self, text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # CatBoost expects a 2D array or similar for .toarray() if it was a sparse TF-IDF
            X_dense = text_vectorized.toarray()
            prediction_encoded = self.model.predict(X_dense)[0]
            
            # Decode label
            if isinstance(prediction_encoded, (list, np.ndarray)):
                prediction_encoded = prediction_encoded[0]
            
            category = self.label_encoder.inverse_transform([prediction_encoded])[0]

            # Get confidence score
            probabilities = self.model.predict_proba(X_dense)[0]
